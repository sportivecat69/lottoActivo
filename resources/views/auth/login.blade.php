...
<!--                 <div class="panel-heading">Inicio de session</div> -->
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('login') }}">
                        {{ csrf_field() }}
                        
                        <div style="margin-left: 210px; margin-top: 10px ; margin-bottom: 30px;">
                        	<img alt="T&T" src="{{ asset('img/logo.png') }}">
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" name="password" required placeholder="Ingrese su contrase&ntilde;a">
